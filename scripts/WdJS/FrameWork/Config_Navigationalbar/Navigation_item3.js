define([
    ...
    "dojo/text!./templates/Navigation_item3.txt",
    "dojo/on",
    "dojo/dom-style",
    "dojo/dom-class", 
    "dojo/dom-attr",
      ...
      return declare([_WidgetBase, _TemplatedMixin], {
          ...
          startup: function () {
              ...
              parser.parse(me.domNode).then(function () {
                ...
                me.menu.innerHTML=me._menutext || "--";
                me._bindEvents();
              });
          },
          _bindEvents:function(){
            ...
            on(me.delete, "click", function (e) {
                ...
                if(confirm("请确认是否删除该标记")){
                    ConfigurationService.deleteSubMenuMOdule(me._data.id,me._menuid).then(function(re){
                        if(re.code=="200"){
                            debugger
                            alert("删除成功");
                            me._table3Fresh();
