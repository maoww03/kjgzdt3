define([
    ...
    "dojo/text!./templates/Module.txt",
    "dojo/on",
    "dojo/dom-style",
    "dojo/dom-class", 
    "dojo/dom-attr",
    "FrameWork/serviceUtil/ConfigurationService",
    "./Module_item","./Module_create"
  ], function (
      declare,
      parser,
      _WidgetBase,
      ...
      domClass,
      domAttr,
      ConfigurationService,Module_item,Module_create
  ) {
      return declare([_WidgetBase, _TemplatedMixin], {
          ...
          _bindEvents:function(){
            ...
            on(me.create, "click", function () {
                var _creat=new Module_create({_data:null , _style:"create",_page:me._nowPage}).placeAt(dojo.body());
                _creat.startup();
                _creat.addrefresh=me.addfresh.bind(me);
            });
          },
          setListItem:function(pageNum){
            ...
            var data={
                ...
                ConfigurationService.getModule(JSON.stringify(data)).then(function(result){
                if(result.code=='200'){
                    var re=result.data;
                    ...
                    for(var i=0;i<re.length;i++){
                        var _Moduleitems=new Module_item({_data:re[i] , _num : i+(pageNum-1)*me.pageSize+1 , _nowPage:pageNum}).placeAt(me.items);
