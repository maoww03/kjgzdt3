define([
    ...
    "dojo/text!./templates/ConflictAnalyBar.txt",
    "dojo/on",
    "dojo/dom-style",
    "dojo/dom-class", 
    "dojo/dom-attr",
    "FrameWork/serviceUtil/ConfigurationService",
    "./ConflictAnalyBar_item",
      ...
      return declare([_WidgetBase, _TemplatedMixin], {
          ...
          _bindEvents:function(){
            ...
            on(me.create, "click", function () {
                var _creat=new ConflictAnalyBar_create({_data:null , _style:"create",_page:me._nowPage,_code: me._selectCode}).placeAt(dojo.body());
                _creat.startup();
          ...
          setListItem:function(pageNum,layerName){
            ...
            debugger
            ConfigurationService.getConflictAnaly(JSON.stringify(page),me._selectCode).then(function(result){
                if(result.code=='200'){
                    debugger
                    var re=result.data;
                    ...
                    for(var i=0;i<re.length;i++){
                        var _Queryitems=new ConflictAnalyBar_item({_data:re[i] , _num : i+(pageNum-1)*me.pageSize+1 , _nowPage:pageNum}).placeAt(me.items);
                        _Queryitems.startup();
