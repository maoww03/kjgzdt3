define(["dojo/_base/declare", "FrameWork/Command", "dojo/_base/lang", "./DownFile_temp"], function (declare, Command, lang, DownFile_temp) {
      ...
      onClick: function (target) {
          if (this.enabled) {
              ...
              if (this._doConflict != null) {
                ...
                this._doConflict = new DownFile_temp().placeAt(dojo.body());
