define([
    ...
    'FrameWork/Command',
    'dojo/_base/lang',
     "dojo/_base/array", 'dojo/on', "dojo/dom-attr", "./RegionBar"
],
    function (declare, Command, lang, array, on, domAttr, RegionBar) {
                ...
                if (this.enabled) {
                    ...
                    if (this.enabled) {
                        ...
                        if (this._widget == null) {
                            this._widget = new RegionBar().placeAt(dojo.byId('sidebox'));
