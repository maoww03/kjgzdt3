define([
    ...
    "dojo/text!./templates/Conflict_item.txt",
    "dojo/on",
    "dojo/dom-style",
    "dojo/dom-class", 
    "dojo/dom-attr",
      ...
      return declare([_WidgetBase, _TemplatedMixin], {
          ...
          startup: function () {
              ...
              parser.parse(me.domNode).then(function () {
                ...
                me.regionCode.innerHTML=me._data.code || "--";
                me.region.innerHTML=me._data.name || "--";
                me._bindEvents();
              });
          },
          _bindEvents:function(){
            ...
            on(me.change, "click", function () {
                var _change=new Conflict_create({_data : me._data,_style:"change"}).placeAt(dojo.body());
                _change.startup();
            ...
            on(me.delete, "click", function (e) {
                ...
                if(confirm("请确认是否删除该标记")){
                    ConfigurationService.deleteConflict1(id).then(function(re){
                        if(re.code=="200"){
                            debugger
                            alert("删除成功");
                            me._itemRefresh();
