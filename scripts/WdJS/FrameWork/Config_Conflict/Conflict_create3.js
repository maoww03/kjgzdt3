define([
    ...
    "dojo/text!./templates/Conflict_create3.txt",
    "dojo/on",
    "dojo/dom-style",
    "dojo/dom-class", 
    "dojo/dom-attr",
    ...
    "FrameWork/serviceUtil/ConfigurationService"
      ...
      return declare([_WidgetBase, _TemplatedMixin], {
        ...
        _createSave:function(data){
            var me=this;
            ConfigurationService.addConflict3(JSON.stringify(data) ).then(function(re){
                if(re.code=='200'){
                    alert("新建成功");
                    me._createRefresh();
                    me.destroy();
        ...
        _changeSave:function(data){ 
            var me=this;
            ConfigurationService.changeConflict3(JSON.stringify(data) ).then(function(re){
                if(re.code=='200'){
                    alert("修改成功");
                    me._createRefresh();
                    me.destroy();
