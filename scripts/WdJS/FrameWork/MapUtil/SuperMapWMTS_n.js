                ...
                if (xmlDoc != null) {
                    try {
						 ...
						 for (var i = 0; i < Layer.length; i++) {
                            if (Layer[i].getElementsByTagName("ows:Title")[0].textContent == config.layerName) {
                                debugger
                                Layer = Layer[i];
                                break;
                            }
                        }
                        var _matrixSet = "Custom_" + config.layerName;
                        //var _layer=config.layerName;
                        var BoundingBox = Layer.getElementsByTagName("ows:BoundingBox")[0];
						...
						var TileMatrixSets = xmlDoc.querySelectorAll("Contents>TileMatrixSet");
                        var TileMatrixSet;
                        for (var i = 0; i < TileMatrixSets.length; i++) {
                            if (TileMatrixSets[i].querySelector("Identifier").innerHTML == _matrixSet) {
