define([
    ...
    "dojo/text!./templates/Sideboxgroup_create.txt",
    "dojo/on",
    "dojo/dom-style",
    "dojo/dom-class", 
    "dojo/dom-attr",
    ...
    "FrameWork/serviceUtil/ConfigurationService"
      ...
      return declare([_WidgetBase, _TemplatedMixin], {
        ...
        _changeSave:function(data){
            var me=this;
            ConfigurationService.changesideboxgroup(JSON.stringify(data) ).then(function(re){
                if(re.code=='200'){
                    debugger
                    alert("修改成功");
                    me._createRefresh();
        ...
        _createSave:function(data){
            var me=this;
            debugger
            ConfigurationService.addsideboxgroup(JSON.stringify(data) ).then(function(re){
                if(re.code=='200'){
                    alert("新建成功");
                    me._createRefresh();
                    me.destroy();
