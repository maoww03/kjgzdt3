define(["dojo/_base/declare", "FrameWork/Command", "dojo/_base/lang", "./conflict_made"], function (declare, Command, lang, conflict_made) {
    ...
    onCreate: function (e) {
      ...
      onClick: function (target) {
          if (this.enabled) {
              ...
              this._doConflict = new conflict_made().placeAt(dojo.body());
