define([
    'dojo/_base/declare',
    'FrameWork/Command',
    'dojo/_base/lang', "dojo/_base/array", 'dojo/on', "dojo/dom-attr", "./HelpBar"
],
    function (declare, Command, lang, array, on, domAttr, HelpBar) {
                ...
                if (this.enabled) {
                    ...
                    if (this.enabled) {
                        ...
                        if (this._widget == null) {
                            this._widget = new HelpBar().placeAt(dojo.byId('sidebox'));
