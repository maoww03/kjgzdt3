  ...
  //20210402
    ...
    return declare([WidgetBase, TemplatedMixin], {
                ...
                if(re.code=='000000'){
                    ...
                    catalogService.getAllLater().then(function(re){
                        if(re.code=='000000'){
                           ...
                           var layerData=re.data['温州市'];
                            // 4-把图层信息放到指定的 me._data2
                           me._doZtreeData(re.data['温州市']);
                        }else{
                            alert(re.msg);
                        }
                    });
        ...
        _addDiyDom: function (treeId, treeNode) {
            ...
            if (treeNode.isParent != true) {
                ...
                if(url==null){
                    $("#" + authorityId).attr("class", "no_authority");
                    $("#" + treeNode.tId).attr("authority", 'no');
                    $("#" + treeNode.tId + "_authority").attr("title", "无权限");

                }else{
                    $("#" + authorityId).attr("class", "authority");
                    $("#" + treeNode.tId).attr("authority", 'yes');
                    $("#" + treeNode.tId + "_authority").attr("title", "有权限");
        ...
        _addcollect: function (collect_id) {
            ...
            $("#" + me._onClickStar.tId + "_star").attr("title", "取消收藏");
